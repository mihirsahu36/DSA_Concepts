...
- For index 0, |0 - 2| > k and |0 - 5| > k,
so there is no j where |0 - j| <= k and nums[j] == key.
...
Output: [0,1,2,3,4]
Explanation: For all indices i in nums,
there exists some index j such that |i - j| <= k and nums[j] == key,
